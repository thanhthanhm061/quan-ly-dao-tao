...
public class LopHocPhan {
    ...
    /**
     * Đổi từ GiangVien → NhanVien.
     * Tên field giữ nguyên "giangVien" để Thymeleaf template ít phải sửa.
     * Tên cột DB đổi từ giang_vien_id → nhan_vien_id (xem migration SQL).
     */
    @ManyToOne
    ...
    public NhanVien getGiangVien() { return giangVien; }
    public void setGiangVien(NhanVien giangVien) { this.giangVien = giangVien; }
    ...
    public TrangThaiLHP getTrangThai() { return trangThai; }
    public void setTrangThai(TrangThaiLHP trangThai) { this.trangThai = trangThai; }

    public List<DangKy> getDangKys() { return dangKys; }
    public void setDangKys(List<DangKy> dangKys) { this.dangKys = dangKys; }

    public List<ThoiKhoaBieu> getThoiKhoaBieus() { return thoiKhoaBieus; }
    public void setThoiKhoaBieus(List<ThoiKhoaBieu> thoiKhoaBieus) { this.thoiKhoaBieus = thoiKhoaBieus; }
